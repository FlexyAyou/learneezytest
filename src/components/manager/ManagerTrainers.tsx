...
import { Search, Plus, Eye, Mail, UserCheck, Phone, MapPin, Calendar, Clock, Euro, EyeOff, UserCircle } from 'lucide-react';
import { useToast } from '@/hooks/use-toast';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
import { TrainerApplicationModal } from '@/components/admin/TrainerApplicationModal';
  ...
  if (error) {
    return (
      <div className="text-center py-8">
        <p className="text-red-600">Erreur lors du chargement des formateurs</p>
      </div>
    );
  }
      ...
      <Dialog open={isInviteModalOpen} onOpenChange={setIsInviteModalOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Envoyez une invitation par email à un nouveau formateur.
            </DialogDescription>
          </DialogHeader>
