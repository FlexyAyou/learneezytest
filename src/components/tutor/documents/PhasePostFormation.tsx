...
import { FileText, Download, Upload, Award, CheckCircle, MessageSquare, FileCheck } from 'lucide-react';
...
interface PhasePostFormationProps {
  selectedFormation: string;
  formations: Formation[];
}

export const PhasePostFormation = ({ selectedFormation, formations }: PhasePostFormationProps) => {
  const { toast } = useToast();
  
  const [documents] = useState<PhaseDocument[]>([
    { id: '1', name: 'Test_Final_Math_CE2.pdf', formationId: '1', type: 'test_final', date: '2024-02-01', size: '1.8 MB', status: 'completed' },
    { id: '2', name: 'Satisfaction_Chaud_Math_CE2.pdf', formationId: '1', type: 'satisfaction_chaud', date: '2024-02-02', size: '0.5 MB', status: 'sent' },
    { id: '3', name: 'Attestation_Math_CE2.pdf', formationId: '1', type: 'attestation', date: '2024-02-03', size: '1.2 MB', status: 'sent' },
    { id: '4', name: 'Certificat_Math_CE2.pdf', formationId: '1', type: 'certificat', date: '2024-02-04', size: '1.5 MB', status: 'sent' },
    { id: '5', name: 'Test_Final_Francais_CM1.pdf', formationId: '2', type: 'test_final', date: '2024-01-30', size: '1.9 MB', status: 'pending' },
  ]);
