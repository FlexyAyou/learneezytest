...
export const DocumentsAdministratifs = ({ selectedFormation, formations }: DocumentsAdministratifsProps) => {
  const phases = [
    {
      id: 'inscription',
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-gray-600">Vue d'ensemble des 4 phases de formation</p>
        </div>
      </div>
      ...
      {filteredFormations.map((formation) => (
        <Card key={formation.id} className="mb-6">
          <CardHeader>
            ...
            <CardDescription>Suivi des phases administratives</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <Card key={phase.id} className="border-l-4 border-l-blue-500">
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-700 mb-2">Documents inclus:</p>
