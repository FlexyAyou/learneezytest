...
import { FileText, Download, School, BookOpen, Calendar, CheckSquare } from 'lucide-react';
...
export const StudentPhaseFormation = ({ selectedFormation, formations }: StudentPhaseFormationProps) => {
  ...
  const [documents] = useState<PhaseDocument[]>([
    { id: '1', name: 'CGV_RI_Math.pdf', formationId: '1', type: 'cgv_ri', date: '2024-01-23', size: '2.1 MB', status: 'signed' },
    ...
    { id: '5', name: 'Programme_Formation_Francais.pdf', formationId: '2', type: 'programme', date: '2024-01-20', size: '2.9 MB', status: 'available' },
  ]);
