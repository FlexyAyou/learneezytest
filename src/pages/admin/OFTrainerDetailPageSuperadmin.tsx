...
const OFTrainerDetailPageSuperadmin = () => {
    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">Le slug "{userSlug}" ne correspond à aucun formateur OF</p>
  ...
  const user = {
    ...
    role: foundUser?.role || 'formateur_interne',
...
export default OFTrainerDetailPageSuperadmin;
