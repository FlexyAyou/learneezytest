        ...
        <div className="max-w-md text-white">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-pink-100">Cryptage de bout en bout</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="h-5 w-5 text-pink-200">✓</div>
              <span className="text-pink-100">Protection contre les attaques</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="h-5 w-5 text-pink-200">✓</div>
              <span className="text-pink-100">Vérification en temps réel</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="h-5 w-5 text-pink-200">✓</div>
              <span className="text-pink-100">Conformité RGPD</span>
            </div>
          </div>
